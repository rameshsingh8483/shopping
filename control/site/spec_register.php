...
<li class="active">Specification Register</li>
</ol>
</div>	
<!--/sub-heard-part-->	
<!--/forms-->
...
<div class="grid-1">
	<div class="form-body">
			...
			<form class="form-horizontal" action="process/spec_register.php" method="POST" id="brand-register" >
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><label>Sub Category</label><select id="subcat-list" name="subcat" class="form-control1">
					<option value="0">Select</option>
					
					</select>
					</div>
					<div class="col-sm-4"><label>Filterable:</label>
					<select name="filter" class="form-control1">
					<option value="1">YES</option>
					<option value="0">NO</option>
					</select>
					</div>
					<div class="col-sm-6"><label>Optional:</label>
					<select name="optional" class="form-control1">
					<option value="0">NO</option>
					<option value="1">YES</option>
					</select>
					</div>
					<div class="col-sm-6"><label>Specification Name:</label> <input type="text" class="form-control1" name="name" placeholder = "Ex. Price "> 
					</div>
					<div class="col-sm-12"><label>Specification Value:</label><br>
					<input type="text" class="form-control1" data-role="tagsinput" name="value[]"> 
					</div>
